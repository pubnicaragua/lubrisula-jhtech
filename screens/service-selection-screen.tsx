...
// ✅ CORREGIDO: Usar el tipo correcto del servicio en lugar del tipo de types/services  
...
export default function ServiceSelectionScreen({ navigation, route }: Props) {  
  ...
  const loadServices = async () => {  
    try {  
      ...
      // ✅ CORREGIDO: Usar directamente los servicios sin mapeo ya que el tipo es correcto  
  ...
  const filterServices = useCallback(() => {  
    ...
    if (searchTerm.trim()) {  
      filtered = filtered.filter(service =>  
        service.producto.toLowerCase().includes(searchTerm.toLowerCase()) ||  
      ...
      >  
        <View style={styles.serviceContent}>  
          <View style={styles.serviceHeader}>  
            <Text style={styles.serviceName}>{item.producto}</Text>  
            {multiSelect && (  
              <TouchableOpacity  
            ...
            <View style={styles.serviceDetails}>  
              <View style={styles.serviceDetail}>  
                ...
                <Text style={styles.serviceDetailText}>  
                  {getDurationText(item.tiempo_estimado)}  
                </Text>  
              </View>  
              {item.categoria && (  
      ...
      >  
        <View style={styles.modalContainer}>  
          ...
          <ScrollView style={styles.modalContent}>  
            <Text style={styles.modalServiceName}>{selectedServiceDetail.producto}</Text>  
            ...
            <View style={styles.modalServiceDetails}>  
              ...
              <View style={styles.modalDetailRow}>  
                ...
                <Text style={styles.modalDetailValue}>  
                  {getDurationText(selectedServiceDetail.tiempo_estimado)}  
                </Text>  
              </View>  
              <View style={styles.modalDetailRow}>  
              ...
              <View style={styles.modalDetailRow}>  
                ...
                <Text style={styles.modalDetailValue}>{selectedServiceDetail.estado}</Text>  
              </View>  
            </View>  
          </ScrollView>  
